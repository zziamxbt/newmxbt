...
public class ArticleCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fresco.initialize(ArticleCommentActivity.this);
    ...
    private void inithttp() {
        ...
        path = application.getArticle_comment_url();
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                adapter=new ArticleCommentAdapter(list,ArticleCommentActivity.this);
