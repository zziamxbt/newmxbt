...
public class CenterFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.centerlayout1, container, false);
...
//        mRecyclerView.setAdapter(new MyRecyclerViewAdapter(getActivity(), datas));
    ...
    private void askForData() {
        RequestParams params = new RequestParams(MyApplication.getMycollect_url());
...
//       RequestParams params= new RequestParams("http://139.129.58.244:8080/ZZIA_MXBT/index_servlet");
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                myRecyclerViewAdapter1 = new MyRecyclerViewAdapter1(getActivity(),savelist);
                recyclerView.setAdapter(myRecyclerViewAdapter1);
                myRecyclerViewAdapter1.setOnItemClickListener(new MyRecyclerViewAdapter1.OnRecyclerViewItemClickListener() {
                    @Override
...
//        mSwipeRefreshWidget.setColorScheme(R.color.white,R.color.blue, R.color.gray,R.color.black);
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE
                        && lastVisibleItem + 1 == myRecyclerViewAdapter1.getItemCount()) {
    ...
    private void initView() {
        recyclerView = (RecyclerView) view.findViewById(R.id.center_recyclerView1);
        mSwipeRefreshWidget = (SwipeRefreshLayout) view.findViewById(R.id.swipe_refresh_widget1);
    }
